package com.fda.inv.security;


import com.fda.inv.domain.Role;
...
public class JwtProvider{
    ...
    @Autowired
    public JwtProvider(@Value("${com.fda.domain.security.jwt.token.secret-key}") String secretKey,
                       @Value("${com.fda.domain.security.jwt.token.expiration}")long validityInMilliseconds) {
    ...
    public List<GrantedAuthority> getRoles(String token) {
        List<Map<String, String>>  roleClaims = Jwts
                .parser()
