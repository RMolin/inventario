...
import com.fda.inv.repo.RoleRepository;
import com.fda.inv.repo.UserRepository;
import com.fda.inv.security.JwtProvider;
...
public class UserService {
    ...
    public Optional<User> signup(String username, String password, String firstName
            , String lastName, String document, String phone, String email) {
        LOGGER.info("New user attempting to sign in");
